...
public class main {
	...
	public static void main(String[] args) {
		...
		*/
		...
		Sede s = new Sede("N� 06 E.T.S.Ing. de Telecomunicaci�n/ E.T.S. Ing. Inform�tica");
		ResponsableDeSede r = new ResponsableDeSede("Andrea Malt�s Urieta");
		s.setResponsable(r);
		
		Sede s2 = new Sede("N� 15 I.E.S. Monterroso (Estepona)");
		...
		*/
		...
		/*
		//Carga un fichero de responsables, lo sube a la BD e imprime en consola los responsables en BD
		CargaFicheros prueba = new CargaFicheros();
		prueba.cargarResponsables("C:\\Users\\Judi\\git\\GestionSedesPeVAU\\Recurso\\ResponsablesDeSede.txt");
		for(ResponsableDeSede r : ResponsableDeSede.listaResponsables()) {
